#!/usr/bin/env python3
"""
Instrumented Traffic Simulation Game for debugging button/callback issues.

- Logs global clicks and handler entry/exit to stdout (flushed).
- Keeps same behavior as app.py but prints extra debug lines so we can trace what happens.
"""
...
class TrafficGameDebugApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # extra click logger on the button
...
if __name__ == "__main__":
    log("Starting TrafficGameDebugApp")
